...
class VoitureElectrique
{
    private :
        ...
        int CODE,annee_fabrication;
        QString photoPath;

    public:
        //Constructeurs
        VoitureElectrique(){};//Constructeur classique
        VoitureElectrique(QString,QString,QString,QString,QString,QString,QString,QString,int,QString,int);//Constructeur parametré
        ...
        bool modifier(QString VIN, QString newPlaqueImmatriculation, QString newMarque, QString newModele, QString newEtat, QString newCharge, QString newMaintenance, QString newDisponibilite, int newAnneeFabrication, int newCODE);
        bool supprimer(QString);
        bool rechercherCODE(int CODE);
